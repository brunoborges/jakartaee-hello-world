 ...
 * submitting thoughts to the Fortune Cookie Generator. It encapsulates the
 * user's input that will be used to generate a personalized fortune.
 * </p>
 * 
...
public class ThoughtsRequest {
	 ...
	 * This allows the framework to instantiate the class when creating objects from
